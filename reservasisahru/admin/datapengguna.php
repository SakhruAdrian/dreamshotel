                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <a class="btn btn-warning" href="tambahuser.php">Tambah Pengguna</a><br>
                            </div>
                                    ...
                                    <thead class="thead-dark">
                                        ...
                                        <?php
                                          ...
                                          while($d = mysqli_fetch_array($data)){
                                            ...
                                            <tr>
                                                <td><?php echo $no++; ?></td>
                                                <td><a><img src="/reservasisahru/gambar/<?php echo $d['gambar'] ?>" width="100px"></a></td>
                                                <td><?php echo $d['nama']; ?></td>
                                                <td><?php echo $d['email']; ?></td>
                                                <td><?php echo $d['akses']; ?></td> 
                                                <td>
                                                <a class="btn btn-success" href="ubahdatapengguna.php?id=<?= $d['id']?>">Edit</a>
                                                <a href="hapus.php?idu=<?php echo $d['id'] ?>" onclick="return confirm('Yakin Anda ingin menghapus user ini?')" class="btn btn-sm btn-danger">Hapus</a> 
                                            </td>
                                            </tr>
                                            <?php
                                        }
