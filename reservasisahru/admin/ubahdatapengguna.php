                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center">Ubah Data Pengguna  <?php echo "$nama"; ?></h3>
                                        </div>
                                        <hr>
                                        <form action="editproses.php" method="post" novalidate="novalidate">
                                                <div class="form-group has-success">
                                                    <label for="cc-name" class="control-label mb-1">Nama Lengkap</label>
                                                    <input id="cc-name" value="<?php echo "$nama"; ?>" name="nama" type="text" class="form-control">
                                                </div>
                                                <div class="form-group">
                                                    <label for="cc-number" class="control-label mb-1">Email</label>
                                                    <input id="cc-number" name="email" type="tel" class="form-control" value="<?php echo "$email"; ?>">
                                                </div>
                                                <div class="row">
                                                    <div class="col-4">
                                                        <div class="form-group">
