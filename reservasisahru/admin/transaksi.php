...
<body>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-envelope"></i><a href="transaksi.php">Confirm</a></li>
                        </ul>
                    </li>
            </div><!-- /.navbar-collapse -->
        </nav>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="breadcrumbs">
            ...
            <div class="col-sm-8">
                <div class="page-header float-right" style="margin-top: 10px">
                    <div class="page-title">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <table class="table">
                                    ...
                                    if(isset($_GET['cari'])){
                                        $cari = $_GET['cari'];
                                        $data = mysqli_query($koneksi,"select * from transaksi where nama like '%".$cari."%'or tgl_in like '%".$cari."%'");             
                                    }else{
                                        $data = mysqli_query($koneksi,"select * from transaksi");       
                                    }
                                    $no = 1;
                                    ...
                                    <tr>
                                        ...
                                        <form method="POST" action="prosesterima.php">
                                            ...
                                            <button class="btn btn-success" type="submit">Cek Out</button>
                                        </form>    
                                        </td>                                   
                                    </tr>
                                    <?php } ?>
