                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <a class="btn btn-warning" href="tambahfasil.php">Tambah Fasilitas</a><br>
                            </div>
                                    ...
                                    <?php
                                          ...
                                          while($d = mysqli_fetch_array($data)){
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $d['nama_fas'];?></td>
                                                <td><?php echo $d['deskripsi'];?></td>
                                                <td>
                                                <a class="btn btn-success" href="ubahdatafasil.php?id=<?= $d['id']?>">Edit</a> 
                                            </td>
                                            </tr>
                                            <?php
                                          }
