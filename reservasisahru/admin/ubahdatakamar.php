                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center">Ubah Data <?php echo "$jenis"; ?></h3>
                                        </div>
                                        <hr>
                                        <form action="editkamar.php" method="post" novalidate="novalidate">
                                                <div class="form-group has-success">
                                                    <label for="cc-name" class="control-label mb-1">Nama Kamar</label>
                                                    <input id="cc-name" value="<?php echo "$jenis"; ?>" name="jenis" type="text" class="form-control">
                                                </div>
                                                <div class="form-group">
                                                    <label for="cc-number" class="control-label mb-1">Jumlah Kamar</label>
                                                    <input id="cc-number" name="jumlah" type="tel" class="form-control" value="<?php echo "$jumlah"; ?>">
                                                </div>
                                                <div class="form-group">
