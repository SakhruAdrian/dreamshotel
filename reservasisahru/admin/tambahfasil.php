...
<body>
    ...
    <div id="right-panel" class="right-panel">
       ...
       <!--  -->
                ...
                <form method="post" action="fasilproses.php" enctype="multipart/form-data">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_fas" class="form-control" placeholder="fasilitas" id="nama_fas" required="required" autocomplete="off">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="des">Deskripsi</label>
                        <input type="text" name="deskripsi" class="form-control" placeholder="keterangan" id="jumlah" required="required" autocomplete="off">
                    </div>
                </div>
                    </div>
                <div class="row">
