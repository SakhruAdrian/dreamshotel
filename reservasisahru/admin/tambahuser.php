    ...
    <div id="right-panel" class="right-panel">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li><a href="datapengguna.php">Kembali</a></li>
                        </ol>
                    </div>
                </div>
            </div>
       ...
       <!--  -->
                <div style=" margin-bottom: 100px; width: 50%;" class="container">
                    <h2 class="alert alert-warning text-center mt-5">TAMBAH USER</h2>
                        <div class="card">
                            <div class="card-header text-center">
                            </div>
                <div class="card-body">
                <div style="margin-left:10px; " class="row mt-2 mx-auto">
                <form method="post" action="userproses.php" enctype="multipart/form-data">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="nama" class="form-control" placeholder="Nama Anda" id="nama" required="required" autocomplete="off">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="des">Masukkan Email</label>
                        <input type="text" name="email" class="form-control" placeholder="Email" id="email" required="required" autocomplete="off">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="des">Masukkan Email</label>
                        <input type="text" name="password" class="form-control" placeholder="password" id="Password" required="required" autocomplete="off">
                    </div>
                </div>
                <div class="col-md-6">
                        <div class="form-group">
                            <label for="akses" class="control-label mb-1">Hak Akses</label>
                            <select name="akses" class="form-control" id="akses" required="required" autocomplete="off">
                                <option>Petugas</option>
                                <option disabled="disable">User</option>
                            </select>
                    </div>
                </div>
                    </div>
