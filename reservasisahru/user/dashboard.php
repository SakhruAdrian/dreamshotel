                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="slider_text text-center">
                                <h3>Dreams Hotel</h3>
                                <p>Nikmati malam Anda yang penuh Mimpi</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="single_slider  d-flex align-items-center justify-content-center slider_bg_2">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="slider_text text-center">
                                <h3>Pemandangan yang bagus</h3>
                                <p>Lewati malam anda dengan pemandangan yang indah</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="single_slider  d-flex align-items-center justify-content-center slider_bg_2">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="slider_text text-center">
                                <h3>Nikmati soremu</h3>
                                <p>Suasana pantai yang menenangkan</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-5 col-lg-5">
                    <div class="about_info">
                        <div class="section_title mb-20px">
                            ...
                            <h3>Hotel Dreams <br>
                                dengan suasana menyegarkan</h3>
                        </div>
                        <p>Hotel pilihan anda yang sangat nyaman dengan fasilitas yang lengkap dibaluri dengan suasana yang tenang bagaikan di langit. </p>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-5 col-lg-5">
                    <div class="about_info">
                        <div class="section_title mb-20px">
                            <span>Makanan</span>
                            <h3>Kita menyediakan makananan<br>
                                segar Dan lezat</h3>
                        </div>
                        <p>Selain mempunyai fasilitas yang lengkap dan dilengkapi dengan pemandangan yang indah & asri, kita juga menyediakan makanan yang segar juga lezat yang bisa anda nikmati dengan keluarga maupun pasangan anda. </p>
                    </div>
                </div>
            </div>
        </div>
